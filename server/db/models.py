...
class User(Base):
    ...
    # relationships
    hashtags = relationship("Hashtag", secondary="user_hashtags")
    question_answers = relationship("UserQuestionAnswer", foreign_keys='user_question_answer.user_id')
    photos = relationship("UserPhoto", foreign_keys='user_photo.user_id')
...
class MatchStatus(Base):
    ...
    id = Column(Integer, autoincrement=True, primary_key=True)
    swiper_id = Column(Integer, ForeignKey('user.id'))
    swiped_id = Column(Integer, ForeignKey('user.id'))
...
class UserQuestionAnswer(Base, SoftDeletable):
    ...
    # relationship
    question = relationship("Question", foreign_keys='question.id')